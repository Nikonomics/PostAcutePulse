...
const renderStep1 = (formData, handleInputChange, validationErrors = {}, touched = {}, selectedPlace, setSelectedPlace) => {
  ...
  const extractAddressComponents = async (place) => {
    ...
    try {
      // Make a request to get detailed place information
      ...
      service.getDetails(
        ...
        (placeResult, status) => {
          if (
            ...
            // Also update the selectedPlace state to show the selected address in the input
            setSelectedPlace({
            ...
            // Fallback to basic parsing from the label
            handleInputChange('street_address', place.label);
  ...
  // Fallback function to parse address from label string
  const parseAddressFromLabel = (label) => {
    ...
    if (parts.length >= 3) {
      ...
      // Second to last might have state and zip
  ...
  const handlePlaceSelect = (place) => {
    if (place) {
      ...
      // Clear fields if place is cleared
          ...
          <div className="form-section">
            ...
            <div className="form-row">
              <div className="form-group mb-3">
                ...
                <input
                  ...
                  className={`form-input ${
                    touched?.deal_name && validationErrors.deal_name ? 'error' : ''
                  }`}
              ...
              <div className="form-group mb-3">
                ...
                <select
                  className={`form-select ${
                    touched?.deal_status && validationErrors.deal_status ? 'error' : ''
                  }`}
            ...
            <div className="form-row">
              <div className="form-group mb-3">
                ...
                <input
                  type="text"
                  className={`form-input ${
                    touched?.facility_name && validationErrors.facility_name ? 'error' : ''
                  }`}
              ...
              <div className="form-group mb-3">
                ...
                <select
                  className={`form-select ${
                    touched?.facility_type && validationErrors.facility_type ? 'error' : ''
                  }`}
            ...
            <div className="form-row">
              <div className="form-group mb-3">
                ...
                <input
                  type="text"
                  className={`form-input ${
                    touched?.country && validationErrors.country ? 'error' : ''
                  }`}
              ...
              <div className="form-group mb-3">
                ...
                <input
                  type="text"
                  className={`form-input ${
                    touched?.state && validationErrors.state ? 'error' : ''
                  }`}
              ...
              <div className="form-group mb-3">
                ...
                <input
                  type="text"
                  className={`form-input ${
                    touched?.city && validationErrors.city ? 'error' : ''
                  }`}
                  value={formData.city || ''}
              ...
              <div className="form-group mb-3">
                ...
                <input
                  type="text"
                  className={`form-input ${
                    touched?.zip_code && validationErrors.zip_code ? 'error' : ''
                  }`}
            ...
            <div className="form-row">
              ...
              <div className="form-group mb-3">
                ...
                <input
                  type="text"
                  className={`form-input ${
                    touched?.phone_number && validationErrors.phone_number ? 'error' : ''
                  }`}
